...
Tell the report what indicators and what charts you will use. For this, a configuration file is needed: **DataDescription.csv** Most of the columns are optional except for: Section, Subsection, Subsection2 and tcdata360_id. 
...
Pick a main theme color for background and main titles. Fixed to blue now, working on it
