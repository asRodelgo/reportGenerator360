...
title <- reportConfig$Report_Title[1]
main_color <- reportConfig$Color[1] #722FF5 "722F37"
section_name <- reportConfig$Section
section_desc <- reportConfig$Section_Description
