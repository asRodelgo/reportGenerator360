...
%% SECTORAL COMPOSITION --------------------------------------------
  \begin{minipage}[c]{0.95\textwidth}
    ...
    \begin{minipage}[c]{0.29\textwidth}  
      \vspace{8ex}
      \begin{minipage}[u]{0.99\textwidth}
      \hspace{4ex}\small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 4,Order == 2)[1,1]}}}
      \vspace{1ex}
      <<sector_sparkline1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=7,fig.width=20,results="asis">>=  
      @      
     \vspace{-1ex}
    ...
    \begin{minipage}[b]{0.99\textwidth}
      ...
      %\vspace{1ex}
      <<sector_sparkline2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=7,fig.width=20,results="asis">>=  
      @      
     \vspace{-1ex}
  ...
  \begin{minipage}[c]{0.29\textwidth} 
    ...
    \begin{minipage}[u]{0.99\textwidth}
      \hspace{4ex}\small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 4,Order == 3)[1,1]}}}
      \vspace{1ex}
      <<sector_sparkline3,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=7,fig.width=20,results="asis">>=  
      @      
     \vspace{-1ex}
     \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 4,Order == 3)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{\Sexpr{filter(subsection_source, Section_ID == 4,Order == 3)[1,1]}}}}
    \end{minipage}
    ...
    \begin{minipage}[b]{0.99\textwidth}
      ...
      %\vspace{1ex}
      <<sector_sparkline4,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=7,fig.width=20,results="asis">>=  
      @      
     \vspace{-1ex}
...
%% Competitiveness -----------------------------
  ...
  \begin{minipage}[b]{0.95\textwidth}
    ...
    \begin{minipage}[c]{0.50\textwidth}
      \hspace{1ex}\small{\textcolor[HTML]{818181}{\Sexpr{paste(filter(subsection_name, Section_ID == 6,Order == 3)[1,1],year)}}}
  ...
  \begin{minipage}[b]{0.95\textwidth}
    ...
    \begin{minipage}[c]{0.53\textwidth}
      \hspace{1ex}\small{\textcolor[HTML]{818181}{\Sexpr{paste(filter(subsection_name, Section_ID == 7,Order == 1)[1,1],year)}}}
      % \vspace*{-0.2cm}
      % \centering
      % \\[8pt]
      % \resizebox{\textwidth}{!}{
      ...
      % }
      % \\[10pt]
      <<lpi_table_countries,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3.5,fig.width=11,results="asis">>=
        @
       \hspace{1ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 7,Order == 1)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{\Sexpr{filter(subsection_source, Section_ID == 7,Order == 1)[1,1]}}}}
    \end{minipage}
    \begin{minipage}[c]{0.45\textwidth}
      ...
      \vspace{-3ex}
      %\hspace{4ex}\footnotesize{\textcolor[HTML]{818181}{\% of GNI per capita}}
      <<entrepr_table_countries,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3.5,fig.width=11,results="asis">>=
        @
