...
## ---- figure_sparkline1 ----
figure_sparkline(Report_data,reportConfig,reportConfig,couName,"figure1")
...
## ---- bar_chart_Markets ----
bar_chart(Report_data,reportConfig,couName, reportConfig$Section[4],"radar1",paste_unit=TRUE)
