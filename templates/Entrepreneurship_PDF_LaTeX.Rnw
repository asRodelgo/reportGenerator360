...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  <<figure_sparkline1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.height=8,fig.width=11,fig.align='right',results="asis">>=  
    @      
    \vspace{-2ex}
    \hspace{2ex}\tiny{\href{https://data.crunchbase.com/docs/2013-snapshot}{\textcolor[HTML]{\Sexpr{main_color}}{Source: Crunchbase snapshot}}}
    \vspace{3ex}
    \end{minipage}
    \begin{minipage}[c]{0.30\textwidth}
  <<figure_sparkline2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.height=8,fig.width=11,fig.align='center',results="asis">>=  
    @      
    \vspace{-2ex}
    \hspace{2ex}\tiny{\href{http://reports.weforum.org/global-competitiveness-index/}{\textcolor[HTML]{\Sexpr{main_color}}{Source: WEF-GCI Report}}}
    \vspace{3ex}
    \end{minipage}
    \begin{minipage}[c]{0.30\textwidth}
  <<figure_sparkline3,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.height=8,fig.width=11,fig.align='center',results="asis">>=  
    @      
    \vspace{-2ex}
    \hspace{2ex}\tiny{\href{http://data.worldbank.org}{\textcolor[HTML]{\Sexpr{main_color}}{Source: World Bank WDI}}}
    \vspace{3ex}
    \end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.55\textwidth}
    ...
    @      
   \hspace{4ex}\scriptsize{\href{http://reports.weforum.org/global-information-technology-report-2016/}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCES: GLOBAL INFORMATION TECHNOLOGY REPORT; }}\href{http://data.worldbank.org}{\textcolor[HTML]{\Sexpr{main_color}}{WORLD BANK - WDI}}}
  \end{minipage}
  \begin{minipage}[c]{0.43\textwidth}
    ...
    @
    \vspace{-1ex}
    \scriptsize{\href{http://iab.worldbank.org/Data/ExploreTopics/Investing-across-sectors}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: INVESTING ACROSS BORDERS}}}
  \end{minipage}
\end{minipage}
...
\begin{minipage}[b]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.50\textwidth} % Doing Business table
   ...
   \\[4pt]
    ...
    \\[6pt]
     \hspace{1ex}\scriptsize{\href{http://www.doingbusiness.org}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: DOING BUSINESS}}}
  \end{minipage}
    ...
    <<line_chart_Policy,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',fig.height=3.5,fig.width=7.5,results="asis">>=  
      @            
    \hspace{4ex}\scriptsize{\href{http://data.worldbank.org}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WORLD BANK WDI}}} 
  \end{minipage}
\end{minipage}
...
\begin{minipage}[b]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.55\textwidth} % WEF Radar
    ...
    @      
    \hspace{4ex}\scriptsize{\href{http://reports.weforum.org/global-competitiveness-index/}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WEF-GCI REPORT}}}
  \end{minipage}
  \begin{minipage}[c]{0.43\textwidth} % 
    ...
    @      
    \vspace{-1ex} 
    \scriptsize{\href{http://data.worldbank.org}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WORLD BANK WDI}}}
  \end{minipage}
\end{minipage}  
...
\begin{minipage}[c]{0.95\textwidth}
    ...
    \end{flushleft} 
     \small{\textcolor[HTML]{818181}{FDI, PUBLIC CAPITAL MARKET AND VENTURE CAPITAL}}
      ...
      \begin{minipage}[c]{0.32\textwidth}
        ...
        @
      \end{minipage}
       \hspace{4ex}\scriptsize{\href{http://reports.weforum.org/global-competitiveness-index/}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCES: WEF-GCI REPORT; }}\href{http://data.worldbank.org}{\textcolor[HTML]{\Sexpr{main_color}}{WORLD BANK - WDI}}}
  \end{minipage}
  ...
  \begin{minipage}[c]{0.95\textwidth} % 
    ...
    \begin{minipage}[c]{0.49\textwidth} % 
      ...
      @      
      \vspace*{-0.2cm} 
      \scriptsize{\href{http://www.gemconsortium.org/data/sets}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: GLOBAL ENTREPRENEURSHIP MONITOR - ADULT POPULATION}}}
    \end{minipage}
    \begin{minipage}[c]{0.49\textwidth} % 
      ...
      @      
      \vspace*{-0.2cm} 
      \scriptsize{\href{http://reports.weforum.org/global-competitiveness-index/}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WEF-GCI REPORT}}}
    \end{minipage}
  \end{minipage}  
  ...
  \begin{minipage}[b]{0.95\textwidth}
    ...
    \begin{minipage}[c]{0.48\textwidth} % WEF Radar
      ...
      @      
      \vspace*{-0.1cm} 
      \scriptsize{\href{http://www.worldbank.org/en/programs/globalfindex}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WORLD BANK - FINDEX}}}
    \end{minipage}
    \begin{minipage}[c]{0.48\textwidth} % 
      ...
      \vspace{1ex}
        ...
        @            
      \vspace{2ex}
      \hspace{4ex}\scriptsize{\href{http://www.enterprisesurveys.org/data/exploretopics/innovation-and-technology}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCES: ENTERPRISE SURVEYS; }}\href{http://reports.weforum.org/global-competitiveness-index/}{\textcolor[HTML]{\Sexpr{main_color}}{WEF-GCI REPORT; }}\href{http://data.worldbank.org}{\textcolor[HTML]{\Sexpr{main_color}}{WORLD BANK - WDI}}}
    \end{minipage}
  \end{minipage}  
...
%% Culture --------------------------------------------
  ...
  \scriptsize{\href{http://www.gemconsortium.org/data/sets}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCES: GLOBAL ENTREPRENEURSHIP MONITOR - ADULT POPULATION; }}\href{http://data.worldbank.org}{\textcolor[HTML]{\Sexpr{main_color}}{WORLD BANK - WDI}}}
  ...
  \scriptsize{\href{http://www.enterprisesurveys.org/data/exploretopics/innovation-and-technology}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCES: ENTERPRISE SURVEYS; }}\href{http://www3.weforum.org/docs/gcr/2015-2016/GCI_Dataset_2006-2015.xlsx}{\textcolor[HTML]{\Sexpr{main_color}}{WEF-GCI REPORT; }}\href{http://data.worldbank.org}{\textcolor[HTML]{\Sexpr{main_color}}{WORLD BANK - WDI}}}
\end{minipage}
