...
\begin{minipage}[t]{0.95\textwidth}
  \begin{minipage}[b]{0.5\textwidth}
      ...
      \vspace{1ex}
        ...
        <<line1.3.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',fig.height=1.5,fig.width=5,results="asis">>=  
        @    
        \end{minipage}
        \vspace{1ex}
        \begin{minipage}[b]{0.45\textwidth}
        <<line1.3.2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',fig.height=3,fig.width=6,results="asis">>=  
        @    
        \end{minipage}
  ...
  \begin{minipage}[b]{0.5\textwidth}  
      ...
      \vspace{1ex}
      <<number1.4,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',fig.height=3,fig.width=12,results="asis">>=  
      @      
     \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 1,Order == 2)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{\Sexpr{filter(subsection_source, Section_ID == 1,Order == 2)[1,1]}}}}
  \end{minipage}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<bar2.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=15,results="asis">>=  
    @
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<line2.2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=2,fig.width=8,results="asis">>=  
    @
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<bar4.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3,fig.width=12,results="asis">>=  
    @
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<number4.2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=15,results="asis">>=  
    @
...
\begin{minipage}[c]{0.95\textwidth}
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<number4.3,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=7,fig.width=15,results="asis">>=  
    @
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<number4.4,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=7,fig.width=15,results="asis">>=  
    @
...
\begin{minipage}[t]{0.95\textwidth}
  ...
  \begin{minipage}[b]{0.5\textwidth}
      ...
      \vspace{1ex}
      <<bar5.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',fig.height=4,fig.width=9,results="asis">>=  
      @     
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<bar6.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=6,fig.width=12,results="asis">>=  
    @
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<number6.2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=15,results="asis">>=  
    @
