...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  if(check_val>0){
    ...
    cat("\\large{\\color{white}") 
    cat(paste0(sprintf("WEF Overall Gender Empowerment \\par \\hspace*{4ex} Rank (%s): \\textbf{%d/%d}", as.character(dataPeriod),rank, rankedTotal)))
    cat("}")
  }
@
    \end{minipage}
...
\begin{minipage}[t]{0.95\textwidth}
    ...
    \begin{minipage}[t]{0.20\textwidth}  
       \small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 1,Order == 5)[1,1]}}}
    \end{minipage}
\end{minipage}
...
\begin{minipage}[t]{0.95\textwidth}
  ...
  \begin{minipage}[t]{0.3\textwidth}
    \small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 2,Order == 1)[1,1]}}}
  \end{minipage}
  \hspace{0.2\textwidth}
  \begin{minipage}[t]{0.5\textwidth}
...
\begin{minipage}[t]{0.95\textwidth}
  ...
  \begin{minipage}[t]{0.25\textwidth}
    \small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 6,Order == 2)[1,1]}}}
  \end{minipage}
  \hspace{0.03\textwidth}
  \begin{minipage}[t]{0.25\textwidth}
    \small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 6,Order == 3)[1,1]}}}
  \end{minipage}
\end{minipage}
