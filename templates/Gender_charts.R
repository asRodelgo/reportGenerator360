...
figure_number_rank_only(Report_data,reportConfig,couName, "figure1", str_wrap_size=30, useRank=TRUE)
...
## ---- line1.1 ----
line_chart_avg(Report_data,reportConfig,couName,reportConfig$Section[1],"bar11",minTime="2012",neighbor="region",max_neighbors = 1)

## ---- line1.2 ----
line_chart_avg(Report_data,reportConfig,couName,reportConfig$Section[1],"line12",minTime="2012",neighbor="region",max_neighbors = 1)
...
## ---- line1.3.2 ----
line_chart_avg(Report_data,reportConfig,couName,reportConfig$Section[1],"line13.2",minTime="2012", neighbor="region",max_neighbors=0, gender=TRUE)

## ---- number1.4 ----
# number_chart(Report_data,reportConfig,couName,reportConfig$Section[1],c("line14"),str_wrap_size=36)
figure_number_rank_only(Report_data,reportConfig,couName, "line14", str_wrap_size=15,useRank=TRUE)
...
## ---- line2.2 ----
line_chart_avg(Report_data,reportConfig,couName,reportConfig$Section[2],"line22",minTime="2012", neighbor="region",max_neighbors=1)

########## Entrepreneurship ##########

## ---- figure_sparkline_Ent1 ----
figure_number_rank_only(Report_data,reportConfig,couName, "number31", str_wrap_size=30,useRank = FALSE)
...
figure_number_rank_only(Report_data,reportConfig,couName, "number32", str_wrap_size=30,useRank = FALSE)
...
figure_number_rank_only(Report_data,reportConfig,couName, "number33", str_wrap_size=30,useRank = FALSE)

########## Business Environment for Women ##########

## ---- bar4.1 ----
bar_chart_gender(Report_data,reportConfig,couName, reportConfig$Section[4],"bar41",paste_unit=FALSE)
...
## ---- bar5.1 ----
bar_chart_gender(Report_data,reportConfig,couName, reportConfig$Section[5],"bar51",paste_unit=FALSE,kind="single_indicator")
...
## ---- bar6.1 ----
bar_chart_gender(Report_data,reportConfig,couName, reportConfig$Section[6],"bar61",paste_unit=FALSE)

## ---- line6.2 ----
line_chart_avg(Report_data,reportConfig,couName,reportConfig$Section[6],"line62",minTime="2012",neighbor="region",max_neighbors = 1)

## ---- number6.3 ----
figure_number_rank_only(Report_data,reportConfig,couName, "number63", str_wrap_size=15, useRank=TRUE)
