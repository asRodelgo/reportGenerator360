...
\begin{minipage}[c]{0.95\textwidth}
  ...
  %  \vspace{1ex}
    <<number1.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=4,fig.width=12,results="asis">>=  
    @
  ...
  %  \vspace{1ex}
    <<number1.2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=4,fig.width=12,results="asis">>=  
    @
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth}
    \begin{minipage}[c]{0.95\textwidth}
      ...
      \hspace*{5ex}\textit{\footnotesize{\textcolor[HTML]{818181}Goods and services acquired from an economy by travelers}}
      \vspace{1ex}
    ...
    \begin{minipage}[c]{0.95\textwidth}
      ...
      \hspace*{5ex}\textit{\footnotesize{\textcolor[HTML]{818181}Expenditure of international visitors including payments}}\newline
      \vspace*{-1ex}
      \hspace*{5ex}\textit{\footnotesize{\textcolor[HTML]{818181}to national carriers for international transport}}
      \vspace{1ex}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth} 
    ...
    \vspace{1ex}
    <<number2.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=12,results="asis">>=  
    @      
...
\begin{minipage}[c]{0.95\textwidth}
  \vspace{5ex}
    ...
    \vspace{1ex}
      <<number4.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=12,results="asis">>=  
      @      
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \end{minipage}  
  \begin{minipage}[c]{0.5\textwidth}
    <<number4.3,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',fig.height=5,fig.width=10,results="asis">>=  
    @ 
