...
\begin{minipage}[t]{0.95\textwidth}
  ...
  \begin{minipage}[b]{0.5\textwidth}
      ...
      @      
     \hspace{4ex}\scriptsize{\href{http://data.worldbank.org/data-catalog/world-development-indicators}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WORLD BANK - WDI}}}
  \end{minipage}
  \begin{minipage}[b]{0.5\textwidth}  
      ...
      @      
     \hspace{4ex}\scriptsize{\href{https://tool.wttc.org/}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WTTC}}}
  \end{minipage}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    @
    %\vspace{-1ex}
    \hspace{4ex}\scriptsize{\href{http://www3.weforum.org/docs/TT15/WEF_TTCR_Dataset_2015.xlsx}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WEF TTCR 2015}}}
  \end{minipage}
  \begin{minipage}[c]{0.5\textwidth}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \end{flushleft} 
  %\small{\textcolor[HTML]{818181}{INTERNATIONAL RECEIPTS}}
  %\\[4pt]
  \begin{minipage}[c]{0.5\textwidth}  
      <<spark1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=8,fig.width=21,results="asis">>=  
      @      
  \end{minipage}
  \begin{minipage}[c]{0.5\textwidth}
    <<spark2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=8,fig.width=21,results="asis">>=  
    @
  \end{minipage}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  \begin{minipage}[c]{0.5\textwidth}  
    ...
    \vspace{1ex}
    <<bar_wrap3,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=4,fig.width=8,results="asis">>=  
    @      
    %\vspace{-1ex}
    \hspace{4ex}\scriptsize{\href{http://data.worldbank.org/data-catalog/world-development-indicators}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WORLD BANK - WDI}}}
  \end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \end{flushleft}
    \begin{minipage}[c]{0.5\textwidth}
      ...
      \vspace{1ex}
      <<bar_wrap2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=10,results="asis">>=  
      @      
      %\vspace{-1ex}
      \hspace{4ex}\hspace{4ex}\scriptsize{\href{https://tool.wttc.org/}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WTTC}}}
    \end{minipage}
    \begin{minipage}[c]{0.5\textwidth}  
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \end{flushleft}
  \hspace{4ex}\small{\textcolor[HTML]{818181}{TOURISM COMPETITIVENESS INDEX}}
  \vspace{1ex}
  <<pie1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=2,fig.width=11,results="asis">>=  
  @      
  %\vspace{-1ex}
  \hspace{4ex}\scriptsize{\href{http://www3.weforum.org/docs/TT15/WEF_TTCR_Dataset_2015.xlsx}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WEF TTCR 2015}}}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  \begin{minipage}[c]{0.83\textwidth}
    \vspace{2ex}
    \begin{flushleft}  
      \small{\textcolor[HTML]{818181}{COMPETITIVENESS INDICATORS}}
    \end{flushleft}
    \vspace*{-0.2cm}
    \centering
    \resizebox{\textwidth}{!}{
    <<table_time_avg1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',results="asis">>=  
    @      
    }
  \end{minipage}
  \begin{minipage}[c]{0.125\textwidth}
    \vspace*{+1cm}
    <<sparklines1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=10.1,fig.width=5.5,results="asis">>=  
    @
    \vspace*{-0.5cm}
  \end{minipage}
  
  \scriptsize{\href{http://www3.weforum.org/docs/TT15/WEF_TTCR_Dataset_2015.xlsx}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WEF TTCR 2015}}}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \end{flushleft}
  \vspace{1ex}
  <<bar_wrap3,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=2.5,fig.width=11,results="asis">>=  
  @      
  %\vspace{-1ex}
  \hspace{4ex}\scriptsize{\href{http://www3.weforum.org/docs/TT15/WEF_TTCR_Dataset_2015.xlsx}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: WEF TTCR 2015}}}
\end{minipage}
