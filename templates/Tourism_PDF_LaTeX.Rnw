...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \end{flushleft}
    \begin{minipage}[c]{0.5\textwidth}
      ...
      \vspace{1ex}
      <<bar_wrap2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=11,results="asis">>=  
      @      
    ...
    \vspace{1ex}
      <<number4,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=11,results="asis">>=  
      @      
