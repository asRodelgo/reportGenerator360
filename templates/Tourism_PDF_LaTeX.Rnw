...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    @
    \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 2,Order == 1)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{\Sexpr{filter(subsection_source, Section_ID == 1,Order == 3)[1,1]}}}}
  \end{minipage}
  \begin{minipage}[c]{0.5\textwidth}
    ...
    @
    \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 2,Order == 2)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{\Sexpr{filter(subsection_source, Section_ID == 1,Order == 4)[1,1]}}}}
  \end{minipage}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  \vspace{5ex}
    ...
    \vspace{1ex}
      <<number4.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=9,results="asis">>=  
      @      
