...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \hspace{4ex}\small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 2,Order == 2)[1,1]}}}
    \vspace{1ex}
    <<numberBig2.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=8,fig.width=14,results="asis">>=  
    @
...
\begin{minipage}[c]{0.95\textwidth}
  \vspace{5ex}
    \begin{minipage}[c]{0.5\textwidth}
      ...
      \vspace{1ex}
      <<bar2.2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=8,results="asis">>=  
      @      
    ...
    \vspace{1ex}
      <<text2.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=8,results="asis">>=  
      @      
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.45\textwidth}
    ...
    \vspace{1ex}
    <<number4.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',fig.height=5,fig.width=8,results="asis">>=  
    @      
  ...
  \begin{minipage}[c]{0.55\textwidth}
    ...
    \vspace{1ex}
    <<radar3.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',fig.height=7,fig.width=9,results="asis">>=  
    @ 
