...
\begin{minipage}[t]{0.95\textwidth}
  ...
  \begin{minipage}[b]{0.5\textwidth}
      ...
      @      
     \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 1,Order == 1)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 1,Order == 1)[1,1]}}}}
  \end{minipage}
  \begin{minipage}[b]{0.5\textwidth}  
      ...
      @      
     \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 1,Order == 2)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 1,Order == 2)[1,1]}}}}
  \end{minipage}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    @
    \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 1,Order == 3)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 1,Order == 3)[1,1]}}}}
  \end{minipage}
  \begin{minipage}[c]{0.5\textwidth}
    ...
    @
    \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 1,Order == 4)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 1,Order == 4)[1,1]}}}}
  \end{minipage}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \hspace{4ex}\small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 2,Order == 1)[1,1]}}}
    \vspace{1ex}
      ...
      @      
  \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 2,Order == 1)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 2,Order == 1)[1,1]}}}}
  \end{minipage}
  \begin{minipage}[c]{0.5\textwidth}
  \hspace{4ex}\small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 2,Order == 2)[1,1]}}}
    ...
    @
  \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 2,Order == 2)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 2,Order == 2)[1,1]}}}}
  \end{minipage}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth}  
    ...
    @      
    \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 2,Order == 3)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 2,Order == 3)[1,1]}}}}
  \end{minipage}
  \begin{minipage}[c]{0.5\textwidth} 
    ...
    @      
    \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 2,Order == 4)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 2,Order == 4)[1,1]}}}}
  \end{minipage}
\end{minipage}      
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \end{flushleft}
    \begin{minipage}[c]{0.5\textwidth}
      ...
      \vspace{1ex}
      <<number3,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=10,results="asis">>=  
      @      
      \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 2,Order == 5)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 2,Order == 5)[1,1]}}}}
    \end{minipage}
    \begin{minipage}[c]{0.5\textwidth}  
      \hspace{4ex}\small{\textcolor[HTML]{818181}{\Sexpr{filter(subsection_name, Section_ID == 2,Order == 6)[1,1]}}}
    \vspace{1ex}
      <<number4,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=10,results="asis">>=  
      @      
      \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 2,Order == 6)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 2,Order == 6)[1,1]}}}}
    \end{minipage}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.40\textwidth}
    ...
    \vspace{1ex}
    <<pie1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',fig.height=7,fig.width=11,results="asis">>=  
    @      
    \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 3,Order == 1)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 3,Order == 1)[1,1]}}}}
  \end{minipage}  
  \begin{minipage}[c]{0.58\textwidth}
    ...
    \centering
    \resizebox{\textwidth}{!}{
    <<table_time,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',results="asis">>=
    @
    }
  \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 3,Order == 2)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 3,Order == 2)[1,1]}}}}
  \end{minipage}
\end{minipage}
...
\begin{minipage}[c]{0.95\textwidth}
  ...
  @      
  \hspace{4ex}\scriptsize{\href{\Sexpr{filter(subsection_sourceLink, Section_ID == 4,Order == 1)[1,1]}}{\textcolor[HTML]{\Sexpr{main_color}}{SOURCE: \Sexpr{filter(subsection_source, Section_ID == 4,Order == 1)[1,1]}}}}
  \end{minipage}
\end{minipage}
