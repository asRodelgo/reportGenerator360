...
\begin{minipage}[c]{0.95\textwidth}
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<number1.1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3.5,fig.width=11,results="asis">>=  
    @
  ...
  \begin{minipage}[c]{0.5\textwidth}
    ...
    \vspace{1ex}
    <<number1.2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3.5,fig.width=11,results="asis">>=  
    @
...
\begin{minipage}[c]{0.95\textwidth}
  \vspace{5ex}
  \hspace{4ex}\small{\textcolor[HTML]{818181}{(*) Receipt for travel items: These expenditures by international inbound visitors, or in their behalf,  to purchase goods and services in the reporting economy.}}
  \vspace{2ex}
  
  \hspace{4ex}\small{\textcolor[HTML]{818181}{Receipts for passenger transport items: These are expenditures by international inbound visitors for all services provided in the international transportation by resident carriers and passenger services performed within an economy by nonresident carriers.}}
