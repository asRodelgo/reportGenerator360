...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in filter\_(.data, .dots = lazyeval::lazy\_dots(...)): object 'reportConfig' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in filter\_(.data, .dots = lazyeval::lazy\_dots(...)): object 'reportConfig' not found}}\end{kframe}
\end{knitrout}
